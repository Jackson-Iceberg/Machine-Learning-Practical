...
class ExperimentBuilder(nn.Module):
    ...
    def plot_grad_flow(self, named_parameters):
        ...
        layers = []
        """
        Complete the code in the block below to collect absolute mean of the gradients for each layer
        in all_grads with the layer names in layers.
        """
        ########################################
